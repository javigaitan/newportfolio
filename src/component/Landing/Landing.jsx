...
const Landing = () => {
    ...
    const [avatarSrc, setAvatarSrc] = useState(Bust);

    const handleMouseEnter = () => {
        setAvatarSrc(BustCool);
    };
                    ...
                    <div className="flex items-center w-full lg:w-1/2">
                        <div className="max-w-2xl mb-4">
                            ...
                            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                                ...
                                <a
                                    href="https://github.com/javigaitan"
                                    target="_blank"
                                    rel="noopener"
                                ...
                                <a 
                                    href="https://api.whatsapp.com/send?phone=3512075102"
                                    target="_blank"
                                    rel="noopener"
                                    className="flex items-center space-x-2 text-green-500 dark:text-gray-400">
